...
__C.TRAIN.RPN_NMS_THRESH = 0.72

""" used to be 0.7     is uesd for overlap"""
...
# IoU >= this threshold)
__C.TEST.NMS = 0.4
"""   used to be 0.3  is used for overlap 0.7 """
...
"""   uesd to be 300  NMS_changed is 1000"""
...
# Data directory
__C.DATA_DIR = osp.abspath(osp.join('/data/ztc/jinke/detection/', 'data'))
